...
(async()=>{
  ...
  await page.goto('http://127.0.0.1:8000/mobile.html?title=ShotDeck%E5%8F%82%E8%80%83&url=https%3A%2F%2Fshotdeck.com%2Fboards%2Fdemo&text=%E5%96%9C%E6%AC%A2%E8%BF%99%E4%B8%AA%E4%BD%8E%E9%A5%B1%E5%92%8C%E9%80%86%E5%85%89');
  ...
  const manifest=await (await page.request.get('http://127.0.0.1:8000/mobile.webmanifest')).json();assert.equal(manifest.share_target.params.url,'url');
