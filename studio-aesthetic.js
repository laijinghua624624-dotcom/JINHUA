(function(root,factory){if(typeof module==='object')module.exports=factory(require('./studio-core'));else root.StudioAesthetic=factory(root.StudioCore);})(globalThis,function(C){
  ...
  function entry(name='未命名参考'){return {id:C.uid(),name,kind:'aesthetic',category:'摄影参考',tags:[],notes:'',requirements:'',link:'',files:[],coverId:null,favorite:false,usedIn:[],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};}
