(function(root,factory){if(typeof module==='object')module.exports=factory(require('./studio-core.js'));else root.StudioPpt=factory(root.StudioCore);})(globalThis,function(C){
  'use strict';
  const THEME={bg:'151A12',ink:'F3F4EB',muted:'ABB69E',accent:'D7EF9B'};
  ...
  async function buildDeck(PptxGenJS,item,kind,topics,getData){
    ...
    function page(title,sub=''){
      ...
      s.addText('LANCE / CONTENT STUDIO',{x:.55,y:.28,w:10,h:.25,fontSize:10,color:THEME.accent,margin:0});
    ...
    cover.addText(kind==='project'?'6条故事\n18–30张视觉参考\n18段8秒AI视频':kind==='deep'?'完整执行方案\n25镜AI视觉参考\n完整AI成片参考':'创意与完整脚本\n3–5张视觉参考\n开场、中间、结尾各8秒AI视频',{x:.7,y:3,w:10,h:2.6,fontSize:27,color:THEME.accent,margin:0,breakLine:false});
    if(kind==='deep'){
