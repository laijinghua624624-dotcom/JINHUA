...
function renderAesthetic(){
  ...
  return hero('AESTHETIC LIBRARY','审美参考库','这里是当前空间的审美资料。My·工作与 My·个人默认隔离，需要时可手动复制单条参考。',btn('添加参考／链接','aesthetic-new','',true)+btn('批量上传','aesthetic-batch')+btn('AI语义检索','aesthetic-semantic')+btn(`回收站${trashCount?' · '+trashCount:''}`,'aesthetic-trash'))+folderToolbar()+
